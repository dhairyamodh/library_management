...
if (input.attr("type") == "password") {
  ...
  input.attr("type", "password");
    ...
    $(document).ready(function() {
        $('#librarian_form').submit((e)=>{
            e.preventDefault();
                var form_data = new FormData($('#librarian_form')[0]);
                var token = $("#librarian_form").attr('token');
            ...
            $('#editlibrarian_form').submit((e)=>{
            e.preventDefault();
                var form_data = new FormData($('#editlibrarian_form')[0]);
                var token = $("#editlibrarian_form").attr('token');
                form_data.append('_token', token);
                console.log(form_data);
                $.ajax({
