            ...
            <div class="container">
                <div class="row">
                    ...
                    {{-- <div class="col-md-6 text-right">
                        <div class="pagenation_links"><a href="index.html">Home</a><i> / </i>Login </div>
                    </div> --}}
                </div>
            </div>
        </div>
                                ...
                                <div>
                                    ...
                                    <div class="section " style="display: flex; justify-content:center;">
                                        <a href="{{ url('/login/facebook') }}"
                                            class="button social-btn btn-social facebook span-left"> <span><i
                                                    class="fa fa-facebook"></i></span><span
                                                class="hide-text">Facebook</span> </a>
                                        <a href="{{ url('/login/twitter') }}"
                                            class="button social-btn btn-social twitter span-left"> <span><i
                                                    class="fa fa-twitter"></i></span> <span class="hide-text">Twitter</span>
                                        </a>
                                        <a href="/login/google" class="button social-btn btn-social googleplus span-left">
                                            <span><i class="fa fa-google"></i></span><span
                                                class="hide-text">Google</span></a>
                                    ...
                                    <div class="section">
                                        ...
                                        <label class="field prepend-icon">
                                            <input id="email" type="email" name="email" value="{{ old('email') }}" required
                                                autofocus class="gui-input {{ $errors->has('email') ? 'is-invalid' : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label class="switch block">
                                                    ...
                                                    <span class="switch-label" for="remember" data-on="YES"
                                                        data-off="NO"></span>
