...
@section('content')
    <div class="modal fade" id="addLibrarian" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="parsley-examples" method="post" action="javascript:void()" id="book_form"
                        token="{{ csrf_token() }}">
    ...
    <div class="modal fade" id="editBook" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="parsley-examples" method="post" action="javascript:void()" id="editbook_form"
                        token="{{ csrf_token() }}">
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button data-toggle="modal" data-target="#addLibrarian"
                            class="btn btn-icon waves-effect waves-light btn-outline-success">Add <i
                            ...
                            @foreach ($books as $row)
                                <tr>
                                    ...
                                    <td><span style="text-transform: capitalize;"
                                            class="badge {{ $row->book_status == 'active' ? 'badge-success' : 'badge-danger' }}"><?php echo $row->book_status; ?></span></td>
                                    <td>{{ $row->book_name }}</td>
                                    ...
                                    <td>
                                        <button type="button"
                                            class="btn btn-icon waves-effect waves-light btn-outline-primary edit"
                                            book_id="{{ $row->id }}"><i class="fe-edit-1"></i></button>
                                        <button type="button"
                                            class="btn btn-icon waves-effect btn-outline-danger mg-l-5 delete"
                                            book_id="{{ $row->id }}"><i class="fe-trash-2"></i></button>
                                    </td>
                                </tr>
                            @endforeach
...
@section('scripts')
    ...
    <script src="../../assets/js/input-spinner/bootstrap-input-spinner.js"></script>
    <script>
