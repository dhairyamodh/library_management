...
@section('content')
    ...
    <section class="sec-padding" style="padding-bottom: 0">
        <div class="container">
            <form class="parsley-examples" method="post" action="javascript:void()" id="addBooks_form"
                token="{{ csrf_token() }}">
                    ...
                    <div class="smart-forms smart-container wrap-3">
                        <div class="frm-row">
                            <div class="section colm colm6">
                                <div class="search">
                                    <label for="names" class="field-label">Search Student</label>
                                    <label class="field prepend-icon">
                                        <input id="user_name" type="text" name="user_name" class="gui-input" required
                                            placeholder="Seach by ID, Name or Email">
                        ...
                        <div class="frm-row" id="assignbook" style="display: none">
                            ...
                            <div class="section colm colm4">
                                <div class="search">
                                    <label for="names" class="field-label">Search Book</label>

                                    <label class="field prepend-icon">
                                        <input id="book_name" type="text" name="book_name" required class="gui-input"
                                            placeholder="Search by ID, Name, INR No. or RFID No. ">
                            ...
                            <div class="section colm colm4">
                                ...
                                <label class="field prepend-icon">
                                    <input class="gui-input date" name="return_date" required id="datepicker" type="text"
                                        readonly placeholder="Choose Return Date">
        ...
        <div class="row">
            <div class="domain-pricing-table-holder table_responsive" style="padding: 10px;background-color:transparent;">
        ...
        <div class="smart-forms smart-container wrap-3">
            <div class="section colm colm4">
                <label for="names" class="field-label">&nbsp;</label>
                <button type="button" class="button btn-primary submit">Submit</button>
            </div>
        </div>
        </div>
    </section>
    ...
    <script>
        $(document).ready(() => {
            ...
            $('body').on('click', '.unique_id', function() {
                ...
                $('#student_data').html('');
                $('#user_id').val(uniqid);
                $('.submit').attr('user_id', uniqid);
                $('#user_name').val($(this).clone().children().remove().end().text());
                getBookData(uniqid);
            })
            ...
            $('body').on('click', '.book_id', function() {
                ...
                $('#book_data').html('');
                $('#book_id').val(uniqid)
                $('#book_name').val($(this).clone().children().remove().end().text());
            });
